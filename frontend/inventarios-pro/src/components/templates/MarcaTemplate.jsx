...
export function MarcaTemplate() {
  ...
  return (
    <Container>
      {/* Condicional para mostrar el modal solo cuando openRegistro es true */}
      {openRegistro && (
        <RegistrarMarca
          dataSelect={dataSelect}
          accion={accion}
          onClose={() => SetopenRegistro(false)} // Cierra el modal al hacer clic en cerrar
        />
      )}
      ...
      <section className="main">
        <TablaMarca SetopenRegistro={SetopenRegistro} setdataSelect ={setdataSelect} setAccion={setAccion} />
      </section>
    </Container>
  );
}
